...
def parse_args():
    ...
    parser.add_argument("-d", "--topdir", dest="topdir", default=join(cwd, 'data'), help="The data directory")
    parser.add_argument("-m", "--model", dest="model", default='mhccat2pep_pepres_relation_massspec_elmo_novar_v3_normal_noeps_bs1024_init1', help="name of the model")
